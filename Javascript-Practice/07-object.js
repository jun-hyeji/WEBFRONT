...
/*  프로피티 : 객체가 가진 데이터
    ...
    //  동일 객체는 protype(중요)이라는 공유 영역을 가지고 있다.
    //  이 객체를 이용, new(인스턴스화)한 모든 인스턴스에 동일한 속성을 공유해 줄수 있다.
    //  상속의 이부 개념을 구현할 수 있다.
    console.log("Member 객체의 prototype영역 : ", Member.prototype);
    ...
    console.log("Member객체의 prototype 영역 :", Member.prototype);
